    ...
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out " +
          ...
          "fixed grid place-items-center overflow-auto inset-0 z-50 bg-black/50",
        className
      )}
      {...props}
    />
...
/**
 * ✅ DialogContent 优化点：
 * - 自动为内容提供 aria-describedby
 * - 即使未传 description 也插入隐藏的 <DialogDescription>
 * - 彻底消除 Missing Description 警告
 */
